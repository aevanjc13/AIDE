...
#Region "Action List Method"
    ...
    MustOverride Function GetActionLstByMessage(ByVal _Message As String, ByRef objResult As List(Of Action)) As Boolean
    MustOverride Function GetActionSummry(ByRef objResult As List(Of Action)) As Boolean
...
#Region "Tasks methods"
    ...
    MustOverride Function ViewTasksSummaryAll(ByVal Current_Date As Date, ByRef objResult As List(Of TaskSummary)) As Boolean
...
#Region "Lesson Learnt Methods"
    MustOverride Function GetAllLessonLearntList(ByRef objResult As List(Of LessonLearnt)) As Boolean
    MustOverride Function GetLessonLearntByProblems(ByRef searchProblem As String, ByRef objResult As List(Of LessonLearnt)) As Boolean
...
#Region "Concern Learnt Methods"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    MustOverride Function GetListOfACtion(Ref_id As String) As List(Of Concern)
    ''' <summary>
    ''' GIANN CARLO CAMILO / CHRISTIAN VALONDO
    ''' </summary>
    ''' <param name="Ref_id"></param>
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    MustOverride Function GetSearchAction(_KeywordAction As String, Ref_id As String) As List(Of Concern)
...
#Region "Skills Matrix Methods"
    ...
    MustOverride Function ViewEmpSkills(ByVal deptID As Integer) As List(Of Skills)
...
#Region "Resource Planner Methods"
    ...
    ''' </summary>
    ''' <remarks></remarks>
    MustOverride Function ViewEmpResourcePlanner(ByVal deptID As Integer) As List(Of ResourcePlanner)
    ...
    MustOverride Function GetAllEmpResourcePlanner(ByVal deptID As Integer, ByVal month As Integer, ByVal year As Integer) As List(Of ResourcePlanner)
    MustOverride Function GetAllEmpResourcePlannerByStatus(ByVal deptID As Integer, ByVal month As Integer, ByVal year As Integer, ByVal status As Integer) As List(Of ResourcePlanner)
