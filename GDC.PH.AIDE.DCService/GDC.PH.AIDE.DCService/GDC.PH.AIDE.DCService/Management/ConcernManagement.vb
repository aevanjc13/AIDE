...
#Region "Concern"
    ...
    Public Function GetListOfACtion(Ref_id As String) As StateData
        Dim ConcernSet As New ConcernSet
        Dim listConcern As List(Of ConcernSet)
        Dim obConcern As New List(Of Concern)
        Dim message As String = ""
        ...
        Try
            listConcern = ConcernSet.GetListOfACtion(Ref_id)
    ...
    Public Function GetSearchAction(_keywordAction As String, Ref_id As String) As StateData
        Dim ConcernSet As New ConcernSet
        Dim listConcern As List(Of ConcernSet)
        Dim obConcern As New List(Of Concern)
        Dim message As String = ""
        ...
        Try
            listConcern = ConcernSet.GetSearchAction(_keywordAction, Ref_id)
...
#Region "Mapping"
    ...
    Public Overrides Function GetMappedFields(objData As Object) As Object
        ...
        ConcernData.Status = objConcern.STATUS
