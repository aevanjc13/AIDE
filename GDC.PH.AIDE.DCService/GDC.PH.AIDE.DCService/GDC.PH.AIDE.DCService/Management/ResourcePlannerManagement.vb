...
#Region "Resource Planner"
    ...
    Public Function ViewEmpResourcePlanner(deptID As Integer) As StateData
        ...
        Try
            ResourceSetLst = ResourceSet.ViewEmpResourcePlanner(deptID)
    ...
    Public Function GetAllEmpResourcePlanner(deptID As Integer, month As Integer, year As Integer) As StateData
        Dim ResourceSet As New ResourcePlannerSet
        Dim ResourceSetLst As List(Of ResourcePlannerSet)
        Dim objResource As New List(Of ResourcePlanner)
        Dim message As String = ""
        ...
        Try
            ResourceSetLst = ResourceSet.GetAllEmpResourcePlanner(deptID, month, year)
    ...
    Public Function GetAllEmpResourcePlannerByStatus(deptID As Integer, month As Integer, year As Integer, statuss As Integer) As StateData
        Dim ResourceSet As New ResourcePlannerSet
        Dim ResourceSetLst As List(Of ResourcePlannerSet)
        Dim objResource As New List(Of ResourcePlanner)
        Dim message As String = ""
        ...
        Try
            ResourceSetLst = ResourceSet.GetAllEmpResourcePlannerByStatus(deptID, month, year, statuss)
