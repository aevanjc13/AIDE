...
Public Class LessonLearntManagement
    ...
    Public Function GetLessonLearntList() As StateData
        Dim lessonLearntSet As New LessonLearntSet
        ...
        Try
            lstLessonLearnt = lessonLearntSet.GetAllLessonLearnts()
    ...
    Public Function GetLessonLearntListByProblem(ByVal searchProblem As String) As StateData
        Dim lessonLearntSet As New LessonLearntSet
        Dim lstLessonLearnt As List(Of LessonLearntSet)
        Dim objLessonLearnt As New List(Of LessonLearnt)
        Dim message As String = ""
        ...
        Try
            lstLessonLearnt = lessonLearntSet.GetLessonLearntsByProblem(searchProblem)
