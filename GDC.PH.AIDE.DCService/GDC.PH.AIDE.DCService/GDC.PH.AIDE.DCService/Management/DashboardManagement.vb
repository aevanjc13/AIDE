...
Public Class DashboardManagement
    ...
    End Function
    Public Function DashbrdGetTaskSummaryTotals(ByVal dateStart As Date) As List(Of DashboardTaskSummaryTotals)
        Dim currDate As Date = Date.Now
        Dim state As StateData = _TaskMgmt.ViewTaskAll(currDate)
    ...
    Public Function DashbrdGetTaskSummary(ByVal dateStart As Date) As List(Of TaskSummary)
        Dim currDate As Date = Date.Now
        Dim state As StateData = _TaskMgmt.ViewTaskAll(currDate)
