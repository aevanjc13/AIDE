...
#Region "Action Operation Contracts"
    ...
    <OperationContract()>
    Function GetActionListByMessage(ByVal _Message As String) As List(Of Action)

    <OperationContract()>
    Function GetActionSummary() As List(Of Action)
...
#Region "Tasks Operation Contracts"
    ...
    <OperationContract()>
    Function ViewTaskSummaryAll(ByVal Current_Date As Date) As List(Of TaskSummary)
...
#Region "Lesson Learnt Operation Contracts"
    ...
    <OperationContract()>
    Function GetLessonLearntList() As List(Of LessonLearnt)

    <OperationContract()>
    Function GetLessonLearntByProblem(ByVal search As String) As List(Of LessonLearnt)
...
#Region "Concern Data Contracts"
    ...
    ''' <remarks></remarks>
    <OperationContract()>
    Function GetListOfACtion(Ref_id As String) As List(Of Concern)
    ...
    ''' <remarks></remarks>
    <OperationContract()>
    Function GetSearchAction(_keywordAction As String, Ref_id As String) As List(Of Concern)
...
#Region "Skill Matrix Operation Contracts"
    ...
    <OperationContract()>
    Function ViewEmpSKills(ByVal deptID As Integer) As List(Of Skills)
...
#Region "Resource Planner Operation Contract"
    ...
    <OperationContract()>
    Function ViewEmpResourcePlanner(ByVal deptID As Integer) As List(Of ResourcePlanner)
    ...
    <OperationContract()>
    Function GetAllEmpResourcePlanner(ByVal deptID As Integer, ByVal month As Integer, ByVal year As Integer) As List(Of ResourcePlanner)

    <OperationContract()>
    Function GetAllEmpResourcePlannerByStatus(ByVal deptID As Integer, ByVal month As Integer, ByVal year As Integer, ByVal status As Integer) As List(Of ResourcePlanner)
...
Public Interface IAideService2
    ...
    <OperationContract()>
    Function DashboardGetTaskSummary(ByVal dateStart As Date) As List(Of TaskSummary)


    <OperationContract()>
    Function DashboardGetTaskSummaryTotals(ByVal dateStart As Date) As List(Of DashboardTaskSummaryTotals)
End Interface
