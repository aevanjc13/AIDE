...
namespace GDC.PH.AIDE.BusinessLayer.DataLayer
{
  public  class clsConcernFactory
    ...
    #region data Members
        ...
        /// </summary>
        /// <param name="keys">primary key</param>
        public List<clsConcern> GetACtionList(string Ref_id)
        {
            return _dataObject.GetListOfACtion(Ref_id);
        }
        ...
        /// </summary>
        /// <param name="keys">primary key</param>
        public List<clsConcern> GetSearchAction(string _keywordAction, string Ref_id)
        {
            return _dataObject.GetSearchAction(_keywordAction, Ref_id);
        }
