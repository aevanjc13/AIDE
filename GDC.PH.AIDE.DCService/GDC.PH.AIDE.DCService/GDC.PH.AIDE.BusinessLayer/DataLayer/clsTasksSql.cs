...
namespace GDC.PH.AIDE.BusinessLayer.DataLayer
{
    ...
    class clsTasksSql : DataLayerBase
    {
        ...
        {
            SqlCommand sqlCommand = new SqlCommand();
            sqlCommand.CommandText = "dbo.[sp_updateTaskStatus]";
            sqlCommand.CommandType = CommandType.StoredProcedure;
            ...
            try
            {
                ...
                sqlCommand.Parameters.Add(new SqlParameter("@COMPLTD_DATE", SqlDbType.DateTime, 8, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.COMPLTD_DATE));
                sqlCommand.Parameters.Add(new SqlParameter("@STATUS", SqlDbType.SmallInt, 2, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.STATUS));
                sqlCommand.Parameters.Add(new SqlParameter("@REMARKS", SqlDbType.VarChar, 200, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.REMARKS));
                sqlCommand.Parameters.Add(new SqlParameter("@EFFORT_EST", SqlDbType.Float, 8, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.EFFORT_EST));
                sqlCommand.Parameters.Add(new SqlParameter("@ACT_EFFORT_EST", SqlDbType.Float, 8, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.ACT_EFFORT_EST));
                sqlCommand.Parameters.Add(new SqlParameter("@ACT_EFFORT_EST_WK", SqlDbType.Float, 8, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.ACT_EFFORT_EST_WK));
                sqlCommand.Parameters.Add(new SqlParameter("@REWORK", SqlDbType.TinyInt, 1, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.REWORK));
                sqlCommand.Parameters.Add(new SqlParameter("@PHASE", SqlDbType.VarChar, 20, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.PHASE));
                sqlCommand.Parameters.Add(new SqlParameter("@OTHERS_1", SqlDbType.VarChar, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.OTHERS_1));
                sqlCommand.Parameters.Add(new SqlParameter("@OTHERS_2", SqlDbType.VarChar, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.OTHERS_2));
                sqlCommand.Parameters.Add(new SqlParameter("@OTHERS_3", SqlDbType.VarChar, 100, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.OTHERS_3));
        ...
        public List<clsTasks_sp> getTaskSummaryAll(DateTime dateStart)
        {
            SqlCommand sqlCommand = new SqlCommand();
