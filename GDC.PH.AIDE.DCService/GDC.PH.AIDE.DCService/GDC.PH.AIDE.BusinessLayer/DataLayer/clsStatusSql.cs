	...
	class clsStatusSql : DataLayerBase 
	{
		...
		public bool Insert(clsStatus businessObject)
		{
			...
			try
			{
				...
				sqlCommand.Parameters.Add(new SqlParameter("@GRP_NAME", SqlDbType.VarChar, 20, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.GRP_NAME));
        ...
        public List<clsStatus> SelectByPrimaryKey(clsStatusKeys keys)
        {
            ...
            try
            {
                sqlCommand.Parameters.Add(new SqlParameter("@GRP_ID", SqlDbType.SmallInt, 2, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, keys.GRP_ID));
                MainConnection.Open();
        ...
        {
				businessObject.GRP_ID = (byte)dataReader.GetInt16(dataReader.GetOrdinal(clsStatus.clsStatusFields.GRP_ID.ToString()));
				businessObject.GRP_NAME = dataReader.GetString(dataReader.GetOrdinal(clsStatus.clsStatusFields.GRP_NAME.ToString()));
