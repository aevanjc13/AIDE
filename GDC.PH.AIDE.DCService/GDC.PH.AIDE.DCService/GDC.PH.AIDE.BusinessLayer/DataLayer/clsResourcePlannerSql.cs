...
namespace GDC.PH.AIDE.BusinessLayer.DataLayer
{
    ...
    class clsResourcePlannerSql : DataLayerBase
    {
        ...
        //        sqlCommand.Parameters.Add(new SqlParameter("@DATE_ENTRY", SqlDbType.VarChar, 20, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, businessObject.DATE_ENTRY));
        ...
        public List<clsResourcePlanner> ViewEmpResourcePlanner(int deptID)
        {
            ...
            try
            {
                sqlCommand.Parameters.Add(new SqlParameter("@deptID", SqlDbType.VarChar, 20, ParameterDirection.Input, false, 0, 0, "", DataRowVersion.Proposed, deptID));
                MainConnection.Open();
        ...
        public List<clsResourcePlanner> GetAllEmpResourcePlanner(int DEPT_ID, int MONTH, int YEAR)
        {
            SqlCommand sqlCommand = new SqlCommand();
        ...
        public List<clsResourcePlanner> GetAllEmpResourcePlannerByStatus(int DEPT_ID, int MONTH, int YEAR, int STATUS)
        {
            SqlCommand sqlCommand = new SqlCommand();
