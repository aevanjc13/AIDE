...
#Region "Methods"
    ...
    Function GetListOfACtion(Ref_Id As String) As List(Of ConcernSet)
    ...
    Function GetSearchAction(_keywrodAction As String, Ref_id As String) As List(Of ConcernSet)
#End Region
