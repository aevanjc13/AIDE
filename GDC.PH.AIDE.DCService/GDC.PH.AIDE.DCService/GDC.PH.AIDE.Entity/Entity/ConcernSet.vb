...
#Region "Properties"
    ...
    Public Property STATUS As String Implements IConcernSet.STATUS
        Get
            Return Me.clsConcern.STATUS
        End Get
        Set(value As String)
            Me.clsConcern.STATUS = value
        End Set
    End Property
...
#Region "CONCERN METHODS"
    ...
    ''LISTVIEW ACTION
    ''GET ALL CONCERN FUNCTION
    Public Function GetListOfACtion(Ref_id As String) As List(Of ConcernSet) Implements IConcernSet.GetListOfACtion
        Try
            Dim lstConcern As List(Of clsConcern)
            Dim lstConcernSet As New List(Of ConcernSet)

            lstConcern = clsConcernFactory.GetACtionList(Ref_id)
    ...
    Public Function GetSearchAction(_keywordAction As String, Ref_id As String) As List(Of ConcernSet) Implements IConcernSet.GetSearchAction
        Try
            Dim lstConcern As List(Of clsConcern)
            Dim lstConcernSet As New List(Of ConcernSet)

            lstConcern = clsConcernFactory.GetSearchAction(_keywordAction, Ref_id)
