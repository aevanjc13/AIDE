...
Public Class LessonLearntSet
    ...
    Public Function GetAllLessonLearnts() As List(Of LessonLearntSet) Implements ILessonLearnt.GetAllLessonLearnts
        Try
            Dim lstLessonLearnt As List(Of clsLessonLearnt)
            Dim lstLessonLearntSet As New List(Of LessonLearntSet)

            lstLessonLearnt = cLessonLearntFactory.GetAll()
    ...
    Public Function GetLessonLearntsByProblem(searchProblem As String) As List(Of LessonLearntSet) Implements ILessonLearnt.GetLessonLearntsByProblem
        Try
            Dim lstLessonLearnt As List(Of clsLessonLearnt)
            Dim lstLessonLearntSet As New List(Of LessonLearntSet)
            Dim keys As clsLessonLearntKeys = New clsLessonLearntKeys(searchProblem)

            lstLessonLearnt = cLessonLearntFactory.GetByProblem(keys)
