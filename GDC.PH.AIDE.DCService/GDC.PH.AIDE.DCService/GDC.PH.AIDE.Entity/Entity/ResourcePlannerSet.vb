...
#Region "Resource Planner"
    ...
    Public Function ViewEmpResourcePlanner(deptId As Integer) As List(Of ResourcePlannerSet) Implements IResourcePlanner.ViewEmpResourcePlanner
        Try
            Dim ResourceLst As List(Of clsResourcePlanner)
            Dim ResourceSetLst As New List(Of ResourcePlannerSet)

            ResourceLst = cResourcePlannerFactory.ViewEmpResourcePlanner(deptId)
    ...
    Public Function GetAllEmpResourcePlanner(deptID As Integer, month As Integer, year As Integer) As List(Of ResourcePlannerSet) Implements IResourcePlanner.GetAllEmpResourcePlanner
        Try
            Dim ResourceLst As List(Of clsResourcePlanner)
            Dim ResourceSetLst As New List(Of ResourcePlannerSet)

            ResourceLst = cResourcePlannerFactory.GetAllEmpResourcePlanner(deptID, month, year)
    ...
    Public Function GetAllEmpResourcePlannerByStatus(deptID As Integer, month As Integer, year As Integer, status As Integer) As List(Of ResourcePlannerSet) Implements IResourcePlanner.GetAllEmpResourcePlannerByStatus
        Try
            Dim ResourceLst As List(Of clsResourcePlanner)
            Dim ResourceSetLst As New List(Of ResourcePlannerSet)

            ResourceLst = cResourcePlannerFactory.GetAllEmpResourcePlannerByStatus(deptID, month, year, status)
