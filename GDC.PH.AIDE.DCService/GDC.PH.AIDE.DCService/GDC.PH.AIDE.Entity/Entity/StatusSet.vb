...
Public Class StatusSet
    ...
    Public Property Group_ID As Short Implements IStatusSet.Group_ID
        Get
            Return Me.cStatus.GRP_ID
        End Get
        Set(value As Short)
            Me.cStatus.GRP_ID = value
            NotifyPropertyChanged("Group_ID")
        End Set
    End Property
    Public Property Group_Name As String Implements IStatusSet.Group_Name
        Get
            Return Me.cStatus.GRP_NAME
        End Get
        Set(value As String)
            Me.cStatus.GRP_NAME = value
