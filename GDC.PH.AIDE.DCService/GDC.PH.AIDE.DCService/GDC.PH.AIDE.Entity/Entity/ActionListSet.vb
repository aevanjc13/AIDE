...
Public Class ActionListSet
    ...
    Public Function GetActionListByMessage(ByVal _ActionMessage As String) As List(Of ActionListSet) Implements IActionLists.GetActionListByMessage
        Try
            ...
            objActionList = Me.cActionFactory.GetByPrimaryKey(key)
    ...
    Public Function GetAllActionList() As List(Of ActionListSet) Implements IActionLists.GetAllActionList
        Try
            Dim objActionList As List(Of clsActionLists)
            Dim lstActionList As New List(Of ActionListSet)
            objActionList = Me.cActionFactory.GetAll()
            If Not IsNothing(objActionList) Then
                For Each cAction As clsActionLists In objActionList
                    Dim newActionList As New ActionListSet(cAction)
