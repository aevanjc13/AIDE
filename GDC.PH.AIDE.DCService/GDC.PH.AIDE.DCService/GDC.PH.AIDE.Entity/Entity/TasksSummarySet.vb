...
#Region "STORED PROCS"
    ...
    Public Function getTaskSummaryAll(dateStart As DateTime) As List(Of TasksSummarySet) Implements ITasksSummary.getTaskSummaryAll
        Try
            Dim objTasksList As List(Of clsTasks_sp)
            objTasksList = cTasksFactory.getTaskSummaryAll(dateStart)
