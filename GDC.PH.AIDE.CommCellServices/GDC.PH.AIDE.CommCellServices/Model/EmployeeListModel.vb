...
Public Class EmployeeListModel
    ...
    Public Sub New(ByVal rawEmployeeList As MyEmployeeList)
        ...
        Me.LocalNumber = rawEmployeeList.LocalNumber
    End Sub

    Public Function ToMyEmployee() As MyEmployeeList
        Return New MyEmployeeList() With {.Name = Me.Name, .Position = Me.Position, .EmailAddress = Me.EmailAddress, .AlternateEmail = Me.AlternateEmail, .WorkMobile = Me.WorkMobile, .LocalNumber = Me.LocalNumber}
    End Function
