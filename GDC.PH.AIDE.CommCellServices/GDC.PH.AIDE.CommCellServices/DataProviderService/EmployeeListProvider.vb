...
Public Class EmployeeListProvider
    ...
    Public Sub SetEmployeeList(ByVal _employee As Employee)
        ...
        Dim _employeeObj As MyEmployeeList = New MyEmployeeList With {.Name = _employee.FirstName + " " + _employee.MiddleInitial + ". " + _employee.LastName, .Position = _employee.Position, .EmailAddress = _employee.EmailAddress, .AlternateEmail = _employee.EmailAddress2, .WorkMobile = _employee.CellNumber, .LocalNumber = _employee.Local}
