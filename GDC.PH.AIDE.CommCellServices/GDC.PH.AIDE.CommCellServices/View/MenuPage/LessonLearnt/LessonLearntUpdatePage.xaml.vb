...
#End Region
    ...
    Public Sub New(_frame As Frame, _lessonLearntModel As LessonLearntModel, _mainWindow As MainWindow)
        InitializeComponent()
...
#Region "Private Methods"
    ...
    Private Sub GetActionReference()
        Try
            If Me.InitializeService() Then
                Dim lstAction As Action() = client.GetActionSummary
    ...
    Private Sub btnUpdate_Click(sender As Object, e As RoutedEventArgs)
        Try
            ...
            If lessonLearnt.Problem.Trim = String.Empty Or lessonLearnt.Resolution.Trim = String.Empty Then
                MsgBox("Please Enter All Required Fields", MsgBoxStyle.Critical, "FAILED")
            Else
                Dim result As Integer = MsgBox("Are you sure?", MsgBoxStyle.YesNo, "UPDATE")
    ...
    Private Sub btnBack_Click(sender As Object, e As RoutedEventArgs) Handles btnBack.Click
        frame.Navigate(New LessonLearntPage(frame, mainWindow))
    End Sub
