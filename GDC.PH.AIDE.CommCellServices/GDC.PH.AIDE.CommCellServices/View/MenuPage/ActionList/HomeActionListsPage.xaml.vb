...
#Region "Main Function/ Method"
    ...
    Private Sub LoadActionList()
        Try
            If Me.InitializeService Then
                lstAction = aide.GetActionSummary()
    ...
    Public Sub LoadActionByMessage(ByVal _message As String)
        Try
            If Me.InitializeService Then
                lstAction = aide.GetActionListByMessage(_message)
                SetPaging(PagingMode._First)
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message)
...
#Region "Events Trigger"
    ...
    Private Sub SearchTextBox_TextChanged(sender As Object, e As TextChangedEventArgs)
        If SearchTextBox.Text = String.Empty Then
            LoadActionList()
        Else
            LoadActionByMessage(SearchTextBox.Text)
        End If
    End Sub
