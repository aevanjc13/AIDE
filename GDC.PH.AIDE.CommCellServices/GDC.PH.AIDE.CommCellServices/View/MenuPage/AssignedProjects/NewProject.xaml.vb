...
Public Class NewProject
    ...
    Public Sub New(_frame As Frame)
    ...
    Public Sub LoadEmployeeList()
        Try
            ...
            Dim lstEmployees As Employee() = _AideServiceClient.GetEmployeeList()

            For Each objEmployee As Employee In lstEmployees
                _EmployeeListDBProvider.SetEmployeeList(objEmployee)
                _Employee1DBProvider.SetEmployeeList(objEmployee)
            Next
            ...
            'for create project
            Dim lstEmployee2 As New ObservableCollection(Of EmployeeModel)
            For Each iEmployee2 As MyEmployee In _Employee1DBProvider.GetEmployees()
                lstEmployee2.Add(New EmployeeModel(iEmployee2))
            Next
            _ProjectViewModel.EmployeeList = lstEmployee2
