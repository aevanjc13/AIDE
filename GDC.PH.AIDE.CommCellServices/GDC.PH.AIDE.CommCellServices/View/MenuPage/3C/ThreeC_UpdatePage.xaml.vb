...
#Region "Methods"
    ...
    Private Sub loadselected()
        ...
        If isSearchTextIsUsed = 0 Then
            ...
            Dim lstConcern As Concern() = _AIDEClientService.GetListOfACtion(_concern.RefID)
        ...
        Else
            ...
            Dim lstConcern As Concern() = _AIDEClientService.GetSearchAction(_GetRefID, txtSearchAction.Text)
            Dim lstConcernList As New ObservableCollection(Of ConcernModel)
    ...
    Private Sub getSelectecDATE(_newViewModel As ConcernViewModel)
        ...
        lstConcern = _AIDEClientService.GetListOfACtion(_concern.RefID)
...
#Region "Buttons/Text - Events"
    Private Sub btnRemoveSelectedAction(sender As Object, e As RoutedEventArgs)
        ...
        Else
            If MsgBox("Are you sure ?", MsgBoxStyle.Question + vbYesNo, "REMOVE") = vbYes Then
                ...
                MsgBox("Successfully Remove Action Reference in concern", MsgBoxStyle.Information)
